...
public class Error extends Exception {
    ...
    public String getMessage(){
        ...
        switch(cod){
            ...
            case 2: dato = "El Campo en Rojo es Obligatorio y tiene un formato: Numérico(N): NN-NNNNNNNN-NN";
                break;
            
            case 3: dato = "El Campo en Rojo es Obligatorio y tiene un formato: Letras(N): Nnn";
                break;
            
            case 4: dato = "El Campo en Rojo es Obligatorio y tiene un formato: Alfanumérico, Ejemplo: Plaza De España 1 5b";
                break;
            
            case 5: dato = "El Campo en Rojo es Obligatorio y tiene un formato: Numérico[N]: NNNNNNNNN";
                break;
