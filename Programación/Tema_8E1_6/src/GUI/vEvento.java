...
public class vEvento extends javax.swing.JDialog {
    ...
    int n, ne;
    private ArrayList <Evento> listadoEvento;
    /**
                    ...
                    .addGroup(pPersonaLayout.createSequentialGroup()
                        ...
                        .addGroup(pPersonaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(pPersonaLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(tTelefono, javax.swing.GroupLayout.DEFAULT_SIZE, 176, Short.MAX_VALUE))))
                    .addGroup(pPersonaLayout.createSequentialGroup()
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(cFecha, javax.swing.GroupLayout.DEFAULT_SIZE, 189, Short.MAX_VALUE))))
                    .addGroup(layout.createSequentialGroup()
        ...
        try {
            ...
            switch(n){
                case 1:
                    ...
                    if(Main.consultar(tEvento.getText()).getNombre() == null){
                        horaI = cIHora.getSelectedItem().toString() + ":" + cIMinuto.getSelectedItem().toString() + ":00";
                        horaF = cFHora.getSelectedItem().toString() + ":" + cFMinuto.getSelectedItem().toString() + ":00";
                        SimpleDateFormat formar = new SimpleDateFormat("yyyy-MM-dd");
                        String fecha = formar.format(cFecha.getDate());
                        Main.añadir(tEvento.getText(), tLugar.getText(), Integer.parseInt(tPlaza.getText()), fecha, horaI, horaF);
                ...
                case 2:
                    ...
                    SimpleDateFormat formar = new SimpleDateFormat("yyyy-MM-dd");
                    String fecha = formar.format(cFecha.getDate());
                    Main.modificar(tEvento.getText(), tLugar.getText(), Integer.parseInt(tPlaza.getText()), fecha, horaI, horaF);
    ...
    private void jListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jListarActionPerformed
        ...
        try{
            bAceptar.setEnabled(true);
            listadoEvento = Main.recibirEvento();
            cargarDatos(listadoEvento.get(0));
                if(n==2){
                    cFecha.setEnabled(true);
                    tLugar.setEnabled(true);
                    cFecha.setVisible(true);
    ...
    private void bInicioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bInicioActionPerformed
        ...
        ne = 0;
        cargarDatos(listadoEvento.get(ne));
    ...
    private void bAdelanteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAdelanteActionPerformed
        ...
        if(ne+1 == listadoEvento.size() ){
            JOptionPane.showMessageDialog(this, "El actual es el Ultimo registro.");
        }
        else{
            ne++;
            cargarDatos(listadoEvento.get(ne));
    ...
    private void bPersonaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bPersonaActionPerformed
        ...
        if(bPersona.getText().equals("Comprobar Persona")){
            Persona p;
            p = Main.consultarPersona(tDNI.getText());
            ...
            if(p.getDni() == null){
                ...
                if(tCIF.getText().equals(p.getCifEmpresa())){
            ...
            Main.añadirPersona(tDNI.getText(), tNombre.getText(), tApellidos.getText(), tDireccion.getText(), 
    ...
    private void cargarDatos(Evento ev){
        ...
        tPlaza.setText(String.valueOf(ev.getnPersonas()));
        SimpleDateFormat formar = new SimpleDateFormat("yyyy-MM-dd");
        Date fecha = null;
        try {
            fecha = formar.parse(ev.getFecha());
    ...
    private String hora( String h){
        return h.substring(0, 2);
    }
    
    private String minuto(String h){
        return h.substring(3, 5);
    }
