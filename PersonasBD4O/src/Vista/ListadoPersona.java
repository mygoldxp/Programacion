 ...
 * @author v6222
 */
public class ListadoPersona extends javax.swing.JFrame {
     ...
     */
    public ListadoPersona(ArrayList<Persona> lista) {
        initComponents();
        cargar(lista);
    }
    
    private void cargar(ArrayList<Persona> lista){
        this.setLocationRelativeTo(null);
        this.setVisible(true);
        listaPersona = new ArrayList();
        listaPersona = lista;
        x = 0;
        tNombre.setText(listaPersona.get(x).getNombre());
        tEdad.setText(String.valueOf(listaPersona.get(x).getEdad()));
        tProfesion.setText(listaPersona.get(x).getProfesion());
        tTelefono.setText(listaPersona.get(x).getTelefono());
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(x<listaPersona.size()-1){
            ...
            JOptionPane.showMessageDialog(this, "Éste es el último Registro.");
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(x>0){
            ...
            JOptionPane.showMessageDialog(this, "Éste es el primer Registro.");
        }
