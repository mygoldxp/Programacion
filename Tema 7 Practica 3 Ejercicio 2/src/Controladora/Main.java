...
public class Main {
    ...
    public static void agregar(String nombre, String apellidos, String telefono, String correo){
        cliente = new Cliente(nombre, apellidos, telefono, correo);
    ...
    public static void ver(javax.swing.JFrame ventana){
        ...
        for(Cliente e : listaCliente){
            dato += "\n" + e.getNombre() + ", " + e.getApellidos() + ", " + e.getTelefono() + ", " + e.getEmail();
            if(e.getHijos().isEmpty()){
                dato += ", Individual" + "\n";
            }
            else{
                dato += ", Familiar:" + "\n";
